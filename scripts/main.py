...
if __name__=='__main__':
    ...
    argParser.add_argument('attribute_list', help = 'The XML in which contains the attributes wished to be kept. Only these attributes will be kept from the inserted dataset file.')
    args = argParser.parse_args()

    inputDatasetFile = args.input_dataset
    attributeListYAML = args.attribute_list
